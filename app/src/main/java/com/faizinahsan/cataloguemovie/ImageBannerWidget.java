...
public class ImageBannerWidget extends AppWidgetProvider {
    private static final String TOAST_ACTION = "com.faizinahsan.cataloguemovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.faizinahsan.cataloguemovie.EXTRA_ITEM";
